...
#region App Methods
	...
	{
		debug("Showing message:{0}",text);
		Gtk.MessageDialog msg = new MessageDialog(this, DialogFlags.DestroyWithParent & DialogFlags.Modal,MessageType.Error,ButtonsType.Ok,true,text);
		msg.Run();
		msg.Destroy();
	}
	...
	protected virtual void OnBtnTranslateClicked(object sender, System.EventArgs e)
	{
